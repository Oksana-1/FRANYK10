  ...
  <main>
    <div class="photo-wrap">
      <div class="city__img-holder">
        ...
        <div class="city__text-wrap">
          ...
          quisquam enim ad, minima ipsa inventore nesciunt aut aliquam
          perferendis itaque ut natus modi. Iure fugiat maxime delectus eius,
          explicabo nam?
        </div>
    ...
    <div class="article-block-cafes">
      <div class="article-wrapper">
        <a class="ligth-asymetry-block" href="" target="">
          <div class="img-holder">
            <div class="franyk1"></div>
          </div>
          <div class="description">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Et
              voluptatem assumenda, quos dolores vitae similique ab at iure
              incidunt enim quaerat, cumque labore fuga perspiciatis saepe
              delectus debitis possimus? Dolor.
            </p>
      ...
      <div class="article-wrapper">
        <a class="dark-asymetry-block" href="" target="">
          <div class="img-holder">
            <div class="franyk2"></div>
          </div>
          <div class="description">
            <p>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ab quia,
              fugit error quo maxime in at consequatur quod veritatis earum
              incidunt, veniam laudantium beatae nostrum inventore ipsa possimus
              quidem? Qui?
            </p>
